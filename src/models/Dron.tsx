...
export const Dron = (props: any)=> {
  const group = useRef()
  const { nodes, materials } = useGLTF('https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/low-poly-spaceship/model.gltf') as any
  return (
...
useGLTF.preload('https://vazxmixjsiawhamofees.https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/low-poly-spaceship/model.gltf.co/storage/v1/object/public/models/bench-2/model.gltf')
